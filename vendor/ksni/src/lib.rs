...
pub trait Tray: Sized + Send + 'static {
    ...
    /// Asks the status notifier item to show a context menu or equivalent UI.
    ///
    /// The x and y parameters are in screen coordinates and hint where to show
    /// eventual windows or menus.
